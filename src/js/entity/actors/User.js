...
export default function createUser() {
  ...
  let miniGunLauncher = new Launcher(miniGun, { shotsPerSecond: 5, ammo: 1000 });
  ...
  let rocketLauncher = new Launcher(rocketGun, { shotsPerSecond: 1.0, autoFire: true, ammo: 599, bulletVel: 300 });
