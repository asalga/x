...
export default function createUser() {
  ...
  let miniGunLauncher = new Launcher(miniGun, { shotsPerSecond: 10, ammo: 0 });
  ...
  let rocketLauncher = new Launcher(rocketGun, { shotsPerSecond: 2.5, autoFire: true, ammo: 599, bulletVel: 100  });
